	...
	<div class="portlet light bordered">
		<div class="portlet-title">
			<div class="caption font-green">
				...
				<span class="caption-subject bold uppercase">Form Edit Bahan</span>
			</div>
		</div>
		<div class="portlet-body form">
			<form action="{{ base_url('dashboard/bahan-patch') }}" method="POST" enctype='multipart/form-data' role="form">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-6">
							<div class="form-group form-md-line-input form-md-floating-label">
								<input name="nama_bahan" type="text" class="form-control" value="{{ $data->nama_bahan }}" id="nama_bahan" required>
								<label for="nama_bahan">Nama Bahan</label>
							</div>
						</div>
						<div class="col-xs-12 col-sm-6">
							<div class="form-group form-md-line-input form-md-floating-label">
								<input name="tanggal_masuk" type="text" class="form-control" value="{{ date('d-m-Y', strtotime($data->tgl_masuk_bahan)) }}" id="tanggal_masuk" onfocus="blur()" required>
								<label for="tanggal_masuk">Tanggal Masuk</label>
							</div>
						</div>
						<div class="col-xs-12 col-sm-3">
							<div class="form-group form-md-line-input form-md-floating-label">
								<input name="jumlah" type="number" class="form-control" value="{{ $data->jumlah_bahan }}" id="jumlah" required>
								<label for="jumlah">Jumlah</label>
							</div>
						</div>
						<div class="col-xs-12 col-sm-3">
							<div class="form-group form-md-line-input form-md-floating-label">
								<input name="satuan_jumlah" type="text" class="form-control" value="{{ $data->satuan_bahan }}" id="satuan_jumlah" required>
								<label for="satuan_jumlah">Satuan</label>
							</div>
						</div>
						<div class="col-xs-12 col-sm-6">
							<div class="form-group form-md-line-input form-md-floating-label">
								<input name="lokasi_simpan" type="text" class="form-control" value="{{ $data->lokasi_bahan }}" id="lokasi_simpan" required>
								<label for="lokasi_simpan">Lokasi Simpan</label>
							</div>
						</div>
						<div class="col-xs-12 col-sm-6">
							<div class="form-group form-md-line-input form-md-floating-label">
								<input name="kondisi_bahan" type="text" class="form-control" value="{{ $data->kondisi_bahan }}" id="kondisi_bahan" required>
								<label for="kondisi_bahan">Kondisi ALat</label>
							</div>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-xs-12 col-sm-4">
							<div class="form-group form-md-line-input form-md-floating-label">
								<input type="text" class="form-control" value="{{ $data->foto_bahan }}" readonly>

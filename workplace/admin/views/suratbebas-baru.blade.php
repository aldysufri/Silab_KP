...
@section('page-title', 'Surat Bebas Baru')
	...
	<div class="portlet light bordered">
		<div class="portlet-title">
			<div class="caption font-green">
				...
				<span class="caption-subject bold uppercase">Form Surat Bebas Baru</span>
			</div>
		</div>
		<div class="portlet-body form">
			<form action="{{ base_url('dashboard/suratbebas-baru/store') }}" method="POST" role="form">

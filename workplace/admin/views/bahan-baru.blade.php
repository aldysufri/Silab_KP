	...
	<div class="portlet light bordered">
		<div class="portlet-title">
			<div class="caption font-green">
				...
				<span class="caption-subject bold uppercase">Form Bahan Baru</span>
			</div>
		</div>
		<div class="portlet-body form">
			<form action="{{ base_url('dashboard/bahan-baru/store') }}" method="POST" enctype='multipart/form-data' role="form">
				<input type="hidden" name="{{ $this->security->get_csrf_token_name() }}" value="{{ $this->security->get_csrf_hash() }}">
				<div class="form-body">
					<div class="row">
						<div class="col-xs-12 col-sm-6">
							<div class="form-group form-md-line-input form-md-floating-label">
								<input name="nama_bahan" type="text" class="form-control" id="nama_bahan" required>
						...
						<div class="col-xs-12 col-sm-6">
							<div class="form-group form-md-line-input form-md-floating-label">
								<input name="kondisi_bahan" type="text" class="form-control" id="kondisi_bahan" required>
					...
					<div class="row">
						...
						<div class="col-xs-1">
								<div class="form-group form-md-line-input form-md-floating-label">
										<a href="{{ base_url('assets/plugins/filemanager/dialog.php?type=1&field_id=foto_bahan&relative_url=0&akey=' . $this->config->item('key.access')) }}" class="btn btn-success rfmanager"><i class="fa fa-photo"></i></a>
								</div>
							</div>
							<div class="col-xs-11">
									<div class="form-group form-md-line-input form-md-floating-label">
										<input class="form-control" id="foto_bahan" name="foto_bahan" type="text"  readonly="readonly" style="padding-left: 1rem">
									</div>
							</div>
					</div>
				</div>

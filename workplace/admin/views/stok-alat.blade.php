	...
	<div class="portlet light bordered">
		<div class="portlet-title">
			<div class="caption font-green">
				...
				<span class="caption-subject bold uppercase">Form Stok Alat Baru</span>
			</div>
		</div>
		<div class="portlet-body form">
			<form action="{{ base_url('dashboard/stok-alat/store') }}" method="POST" enctype='multipart/form-data' role="form">
				...
				<div class="form-body">
					<div class="row">
						<div class="col-xs-12 col-sm-6">
                            ...
                            <input type="text" value="alat" id="type" name="type" hidden>
